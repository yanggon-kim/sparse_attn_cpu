...
docs/longbench_locality.md       LongBench validation: R1/R2/R3 on a real benchmark (36 runs, error bars)
docs/longbench_sweep/            LongBench aggregate, sample manifest, and figures
